...
TUẦN 1: 4/12 - 11/12
	...
	* Đã làm được:
		...
		Bài 1:
			Tìm hiểu về Makefile. Build và run chương trình thông qua Makefile

		Bài 2:
			4 quá trình biên dịch của 1 chương trình C
		...
		Bài 3:
			Tạo tài khoản C/C++ Institute và hoàn thành C Essentials - Part 1 (Basics)
...
TUẦN 8: 28/1 - 3/2
	...
	* Đã làm được:
		...
		Bài 1:
			Triển khai hoàn thành chứng chỉ C Essentials - Part 3 (Advanced)
				Hoàn thành module 6, 7, 8 - Hoàn thành C Essentials - Part 3 (Advanced)
